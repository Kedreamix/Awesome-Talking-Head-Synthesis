...
| ---- | ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- |
| 2023 | [Implicit Identity Representation Conditioned Memory Compensation Network for Talking Head Video Generation](https://arxiv.org/abs/2307.10008) | ICCV 2023           | [Code](https://chat.openai.com/c/insert_code_link_here)      | [Project](https://chat.openai.com/c/insert_project_link_here) | -          |
| 2023 | [ToonTalker] [ToonTalker: Cross-Domain Face Reenactment](https://chat.openai.com/c/insert_paper_link_here) | ICCV 2023           | -                                                            | -                                                            | -          |
| 2023 | [Efficient Emotional Adaptation for Audio-Driven Talking-Head Generation](https://chat.openai.com/c/insert_paper_link_here) | ICCV 2023           | [Code](https://chat.openai.com/c/insert_code_link_here)      | [Project](https://chat.openai.com/c/insert_project_link_here) | -          |
| 2023 | [EMMN] [EMMN: Emotional Motion Memory Network for Audio-driven Emotional Talking Face Generation](https://chat.openai.com/c/insert_paper_link_here) | ICCV 2023           | -                                                            | -                                                            | Emotion    |
| 2023 | [Emotional Listener Portrait: Realistic Listener Motion Simulation in Conversation](https://chat.openai.com/c/insert_paper_link_here) | ICCV 2023           | -                                                            | -                                                            | Emotion    |
...
| 2023 | [SadTalker] [SadTalker: Learning Realistic 3D Motion Coefficients for Stylized Audio-Driven Single Image Talking Face Animation](https://arxiv.org/pdf/2211.12194.pdf) | CVPR 2023           | [Code](https://github.com/Winfredy/SadTalker)                | [Project](https://sadtalker.github.io/)                      | 3D         |
