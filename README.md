...
| ---- | ------------------------------------------------------------ | --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------- |
| 2024 | [GaussianTalker] [GaussianTalker: Speaker-specific Talking Head Synthesis via 3D Gaussian Splatting](https://arxiv.org/abs/2404.14037v1) | Arxiv 2024            |                                                              |                                                              | 🔥Gaussian Splatting    |
...
| 2024 | Efficient 3D Implicit Head Avatar with Mesh-anchored Hash Table Blendshapes | CVPR 2024          |                                                          | [Project](https://augmentedperception.github.io/monoavatar-plus/) | Blendshapes                         |
