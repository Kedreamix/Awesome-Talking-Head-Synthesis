...
| Year | Title                                                        | Conference/Journal | Code                                                  | Project                                                    | Keywords            |
| ---- | ------------------------------------------------------------ | ------------------ | ----------------------------------------------------- | ---------------------------------------------------------- | ------------------- |
| 2024 | [GaussianHead] [GaussianHead: Impressive 3D Gaussian-based Head Avatars with Dynamic Hybrid Neural Field](https://arxiv.org/abs/2312.01632) |                    | [Code](https://github.com/chiehwangs/gaussian-head)   |                                                            | 🔥Gaussian Splatting |
| 2024 | [MonoGaussianAvatar] [MonoGaussianAvatar: Monocular Gaussian Point-based Head Avatar](https://arxiv.org/abs/2312.00846) |                    |                                                       |                                                            | 🔥Gaussian Splatting |
| 2024 | [HeadGaS] [HeadGaS: Real-Time Animatable Head Avatars via 3D Gaussian Splatting](http://arxiv.org/abs/2312.02902v1) |                    |                                                       |                                                            | 🔥Gaussian Splatting |
| 2024 | [GaussianAvatars] [GaussianAvatars: Photorealistic Head Avatars with Rigged 3D Gaussians](http://arxiv.org/abs/2312.02069v1) |                    |                                                       | [Project](https://shenhanqian.github.io/gaussian-avatars)  | 🔥Gaussian Splatting |
...
| 2024 | [R2-Talk] [R2-Talker: Realistic Real-Time Talking Head Synthesis with Hash Grid Landmarks Encoding and Progressive Multilayer Conditioning](https://arxiv.org/abs/2312.05572) |                    |                                                       |                                                            |                     |
